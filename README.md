...
<body>
    ...
    <div class="container">
        ...
        <div id="fill-gaps" class="game-section active">
            ...
            <div class="question">
                <h3>Question 1:</h3>
                <p>The concert was so <input type="text" class="fill-blank" data-answer="crowded" placeholder="answer"> that we could barely move through the audience.</p>
                <div class="feedback" id="feedback-1" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>Question 2:</h3>
                <p>She didn't want to <input type="text" class="fill-blank" data-answer="hold back" placeholder="answer"> her opinions any longer and finally spoke her mind.</p>
                <div class="feedback" id="feedback-2" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>Question 3:</h3>
                <p>The new software shows a significant <input type="text" class="fill-blank" data-answer="improvement" placeholder="answer"> over the previous version with its faster processing speed.</p>
                <div class="feedback" id="feedback-3" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>Question 4:</h3>
                <p><input type="text" class="fill-blank" data-answer="Perhaps" placeholder="answer"> we should reconsider our approach since the initial plan isn't working as expected.</p>
                <div class="feedback" id="feedback-4" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>Question 5:</h3>
                <p>The instructions are <input type="text" class="fill-blank" data-answer="basically" placeholder="answer"> the same for all models, with only minor variations.</p>
        ...
        <div id="matching" class="game-section">
            <h2 style="text-align: center; margin-bottom: 20px; color: #ff7e5f;">Match the terms with their meanings</h2>
            <div class="matching-container">
                ...
                <div class="match-column">
                    <h4>Meanings</h4>
                    <div class="match-item" data-meaning="improvement" onclick="selectMatch(this)">An act of making something better</div>
                    <div class="match-item" data-meaning="basically" onclick="selectMatch(this)">In the most essential respects; fundamentally</div>
                    <div class="match-item" data-meaning="crowded" onclick="selectMatch(this)">Full of people or things, leaving little space</div>
                    <div class="match-item" data-meaning="hold back" onclick="selectMatch(this)">To hesitate to act or speak; to restrain</div>
        ...
        <div id="multiple-choice" class="game-section">
            <div class="question">
                <h3>Question 1: What does "hold back" mean?</h3>
                <div class="options">
                    ...
                    <div class="option" onclick="selectOption(this, true)">To hesitate or restrain oneself</div>
            ...
            <div class="question">
                <h3>Question 2: Which word means "in the most essential respects"?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">perhaps</div>
                    <div class="option" onclick="selectOption(this, true)">basically</div>
            ...
            <div class="question">
                <h3>Question 3: "Crowded" refers to:</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">Something that is popular</div>
                    <div class="option" onclick="selectOption(this, false)">A noisy environment</div>
                    <div class="option" onclick="selectOption(this, true)">A space full of people or things</div>
                    <div class="option" onclick="selectOption(this, false)">A complicated situation</div>
                </div>
                <div class="feedback" id="mc-feedback-3" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>Question 4: What is an "improvement"?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">A suggestion for change</div>
                    <div class="option" onclick="selectOption(this, true)">An act of making something better</div>
                    <div class="option" onclick="selectOption(this, false)">A movement forward</div>
                    <div class="option" onclick="selectOption(this, false)">A new version of something</div>
                </div>
                <div class="feedback" id="mc-feedback-4" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>Question 5: "Perhaps" is used to express:</h3>
                <div class="options">
